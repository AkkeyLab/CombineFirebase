#
# Be sure to run `pod lib lint CombineFirebaseFunctions.podspec' to ensure this is a
...
Pod::Spec.new do |s|
    s.name             = 'CombineFirebaseFunctions'
    s.version          = '0.2.7'
    s.summary          = 'Combine extensions for Firebase Functions.'
    ...
    s.description      = <<-DESC
    Combine extensions for Firebase/Functions.
    DESC
