#
# Be sure to run `pod lib lint CombineFirebaseDatabase.podspec' to ensure this is a
...
Pod::Spec.new do |s|
    s.name             = 'CombineFirebaseDatabase'
    s.version          = '0.2.7'
    s.summary          = 'Combine extensions for Firebase Database.'
    ...
    s.description      = <<-DESC
    Combine extensions for Firebase/Database.
    DESC
